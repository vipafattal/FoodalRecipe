package com.magenta.foodalrecipe.utils.customViews
...
import com.magenta.foodalrecipe.utils.customViews.helpers.get
import com.magenta.foodalrecipe.utils.customViews.helpers.getDim
...
import com.magenta.foodalrecipe.utils.customViews.onClick.cardBackgroundAnimator
import com.magenta.foodalrecipe.utils.customViews.onClick.loadDefaultActionState
...
class MagentaNav : LinearLayout {
    ...
    var cardNavElevation = screenUtils.dp(3f)
    ...
    fun animateNavigationItem(position: Int){
